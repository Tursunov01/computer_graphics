...
def draw_axis():
    canv.create_line([OX, 0], [OX, can_h - 3])
    canv.create_line([0, OY], [can_w, OY])
    canv.create_polygon([OX, 3], [OX - 5, 13], [OX + 5, 13])
    canv.create_polygon([can_w, OY], [can_w - 10, OY - 5], [can_w - 10, OY + 5])
    canv.create_text(OX + 15, 10, text="Y", font="Font")
    canv.create_text(can_w - 10, OY - 15, text="X", font="Font")
    ...
    if key == "Переместить":
        ...
        if dy1 != "" and dx1 != "":
            ...
            if code == 0:
                ...
                return -1, -1, -1, -1, -1
    if key == "Повернуть":
        degree = table_name3.get()
        xc = table_name4.get()
        yc = table_name5.get()
        code = check_point(degree)
        if xc == "" or yc == "":
            return -1, -1, -1, -1, -1
        else:
            xc = float(xc)
...
def options(key):
    if key == "Переместить":
        ...
        if code == -1:
            ...
            transfer(dx, dy)
    if key == "Повернуть":
        code, c, xc, yc, degree = checker(key)
        if code == -1:
            messagebox.showerror("Ошибка!"
            ...
            turn(xc, yc, degree)
    if key == "Масштабирование":
        code, kx, ky, xc, yc = checker(key)
        if code == -1:
            messagebox.showerror("Ошибка!"
            , "Данные для масштабирования введены неверно.\nПроверьте на правельность ввода")
            table_name6.delete(0, END)
            table_name7.delete(0, END)
            table_name8.delete(0, END)
            table_name9.delete(0, END)
            table_name6.focus_set()
            return -1
        else:
            zoomer(kx, ky, xc, yc)
...
head1.grid(row = 0, column = 0 ,pady = 5, sticky = W, columnspan = 2)

table_name1 = Entry(root, width = 8)
table_name1.grid(row = 1, column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)
table_name1.focus_set()

head1 = Label(text = "dx", font = "Helvetica 10 bold")
head1.grid(row = 1, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name2 = Entry(root, width = 8)
table_name2.grid(row = 2, column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head1 = Label(text = "dy", font = "Helvetica 10 bold")
head1.grid(row = 2, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name3 = Entry(root, width = 8)
table_name3.grid(row = 4 ,column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head1 = Label(text = "degree", font = "Helvetica 10 bold")
head1.grid(row = 4, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name4 = Entry(root, width = 8)
table_name4.grid(row = 5 ,column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head1 = Label(text = "xc", font = "Helvetica 10 bold")
head1.grid(row = 5, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name5 = Entry(root, width = 8)
table_name5.grid(row = 6 ,column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head1 = Label(text = "yc", font = "Helvetica 10 bold")
head1.grid(row = 6, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name6 = Entry(root, width = 8)
table_name6.grid(row = 8, column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head = Label(text = "kx", font = "Helvetica 10 bold")
head.grid(row = 8, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name7 = Entry(root, width = 8)
table_name7.grid(row = 9, column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head1 = Label(text = "ky", font = "Helvetica 10 bold")
head1.grid(row = 9, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name8 = Entry(root, width = 8)
table_name8.grid(row = 10 ,column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head1 = Label(text = "xc", font = "Helvetica 10 bold")
head1.grid(row = 10, column = 1 ,pady = 2, sticky = W, padx = 10)

table_name9 = Entry(root, width = 8)
table_name9.grid(row = 11 ,column = 0, padx = 3 ,pady = 2, sticky = W, columnspan = 2)

head1 = Label(text = "yc", font = "Helvetica 10 bold")
head1.grid(row = 11, column = 1 ,pady = 2, sticky = W, padx = 10)
